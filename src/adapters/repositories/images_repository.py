...
from src.adapters.exceptions import ImagesBucketError, NoFileContentError, FileSizeError, InvalidFileTypeError
...
class AWSS3ImagesRepository(ImagesRepository):
    ...
    async def _upload_image(self, content: BytesIO, filename: str, username: str) -> str:
    ...
    async def _delete_last_if_exceeds_5(self, s3, email):
